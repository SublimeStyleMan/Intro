...
/* package Intro-0.1.0.0 */
#ifndef VERSION_Intro
#define VERSION_Intro "0.1.0.0"
#endif /* VERSION_Intro */
#ifndef MIN_VERSION_Intro
#define MIN_VERSION_Intro(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Intro */
...
#define CURRENT_COMPONENT_ID "Intro-0.1.0.0-inplace-Intro"
