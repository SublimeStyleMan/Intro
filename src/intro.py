...
print(3+4) 
# Wow there is a lot of cool stuff that I can do. I can create whole systems and thigs that I couldn't do before
# Many it is taking forever to install haskell that I feel a little bad about doing it. ghci
